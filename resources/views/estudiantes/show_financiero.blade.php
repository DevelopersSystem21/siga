    ...
    <div class="row-fluid bg-white rounded border">
        <nav>
            <div class="nav nav-tabs bg-secondary  rounded-top" id="nav-tab" role="tablist">
                ...
                <a href="{{ route('estudiantes.showFinanciero', $estudiante) }}" class="nav-link active btn-primary text-white" id="informacion_financiera-tab" data-bs-target="#informacion_financiera"
        ...
        <div class="container p-3">
            <div class="tab-content bg-white" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="informacion_financiera" role="tabpanel" aria-labelledby="informacion_financiera-tab" tabindex="0">
    ...
    <script>
        new Vue({
            ...
            created() {
                ...
                this.recibo.id_serie = this.recibo_series.length > 0 ? this.recibo_series[0].id : '';
                this.recibo.id_tipo = this.recibo_tipos.length > 0 ? this.recibo_tipos[0].id : '';
                this.recibo.id_cuenta = this.cuentas.length > 0 ? this.cuentas[0].id : '';
            ...
            methods: {
                ...
                obtenerCorrelativo() {
                    this.$http.get('/pagos/correlativo/' + this.recibo.id_serie + '/' + this.recibo.id_tipo).then(function(response) {
                        this.otros_datos.correlativo = response.data.correlativo;
                        this.otros_datos.fecha = response.data.fecha;
                        this.otros_datos.hora = response.data.hora;
                    });
                },
                registrarPago() {
                    ...
                    this.$http.post('/estudiantes/{{ $estudiante->id }}/pagos', {
                        ...
                        window.open('/pagos/' + response.data, '_blank');
                        location.reload();
                    });
                },
                sumar() {
            ...
            watch: {
                ...
                'recibo.id_serie': function(val) {
                    this.obtenerCorrelativo();
                },
                'recibo.id_tipo': function(val) {
                    this.obtenerCorrelativo();
                }
            }
        })
            ...
            methods: {
                ...
                eliminar: function(recibo_id) {
                    ...
                    Swal.fire({
                        ...
                        self.$http.delete('/creditos/' + recibo_id).then(function() {
                            location.reload();
                        });
                    });
                },
                marcar: function(recibo_id) {
                    let self = this;
                    Swal.fire({
                        title: '¿Estás seguro que desea marcar este crédito como pagado?',
                        icon: 'error',
                        showCancelButton: true,
                        ...
                        self.$http.patch('/creditos/' + recibo_id).then(function() {
                            location.reload();
                        });
                    });
                },
