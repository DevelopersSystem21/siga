                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('pais.store')}}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="descripcion" class="form-label">Codigo País</label>
                                <input type="text" class="form-control" name="codigopais"
                                autocomplete="off">
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label">Nombre</label>
                                <input type="text" class="form-control" name="nompais"
                                autocomplete="off">
                            </div>
            ...
            <div class="row d-flex justify-content-between align-items-center pr-3">
                ...
                <div class="col-4 d-flex justify-content-end mr-3">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalRegistrar">
                        <i class="fa fa-circle-plus" aria-hidden="true"></i>Agregar pais</button>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-end pr-5">
                                ...
                                data-bs-target="#modalEditar{{$pais->idpais}}" title="Editar">
                                <i class="fas fa-fw fa-pen" aria-hidden="true"></i>
                                </button>
                                <form id="deleteForm" action="{{ route('pais.destroy', $pais) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="modalEditar{{$pais->idpais}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('pais.update',$pais)}}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="codigopais"
                                                value="{{$pais->codigopais}}" autocomplete="off">
                                            </div>
                                            <div class="mb-3">
                                                <label for="descripcion" class="form-label">Nombre</label>
                                                <input type="text" class="form-control" name="nompais"
                                                value="{{$pais->nompais}}" autocomplete="off">
                                            </div>    
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                                <button type="submit" class="btn btn-primary">Registrar</button>
