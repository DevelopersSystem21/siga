        ...
        <div class="col-12">
            ...
            <div class="modal fade" id="modalRegistrar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar Turno</h1>
            ...
            <div class="row d-flex justify-content-between align-items-center pr-3">
                ...
                <div class="col-4 d-flex justify-content-end mr-3">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalRegistrar">
                        <i class="fa fa-circle-plus" aria-hidden="true"></i>Agregar turno</button>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-end pr-5">
                                ...
                                data-bs-target="#modalEditar{{$turno->id}}" title="Editar">
                                <i class="fas fa-fw fa-pen" aria-hidden="true"></i>
                                </button>
                                <form id="deleteForm" action="{{ route('turno.destroy', $turno) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="modalEditar{{$turno->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('turno.update',$turno)}}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                value="{{$turno->nombre}}" autocomplete="off">
                                            </div>        
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                                <button type="submit" class="btn btn-primary">Registrar</button>
