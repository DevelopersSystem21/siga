                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                  ...
                                  <div class="mb-2">
                                   ...
                                   <div class="mb-2">
                                        <label for="fecha-fin" class="form-label">Cargo</label>
                                        <select class="form-select" aria-label="Default select example">
                                            <option selected>Select Option</option>
                                            <option value="masculino">Secretaria</option>
                                            <option value="femenino">Contador</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row d-flex justify-content-between align-items-center pr-3">
                ...
                <div class="col-4 d-flex justify-content-end mr-3">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalRegistrar">
                        <i class="fa fa-circle-plus" aria-hidden="true"></i>Agregar Personal</button>
                </div>
            </div>
